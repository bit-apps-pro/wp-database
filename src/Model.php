 ...
 * @method static QueryBuilder                      selectRaw($column, $bindings = [])
 ...
 * @method static QueryBuilder                      onRaw($sql, $bindings = [], $bool = 'AND')
 * @method static QueryBuilder                      orOnRaw($sql, $bindings = [])
 ...
 * @method static object|null                       unsafeRaw($sql, $bindings = [])
 * @method static object|null                       rawPrepared($template, $bindings = [], $identifiers = [], $directions = [])
