...
/**
 * Compiles a deliberately constrained, developer-authored SQL template.
 *
 * Values remain wpdb placeholders. Dynamic structure is accepted only through
 * typed identifier and direction markers with exactly consumed value maps.
 */
